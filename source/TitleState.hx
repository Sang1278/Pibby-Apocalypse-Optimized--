...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			// music.loadStream(Paths.music('freakyMenu_${Main.funnyMenuMusic}'));
		...
		logoBl.frames = Paths.getSparrowAtlas('logoPeb');
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 16:
				        addMoreText('');
				case 17:
					addMoreText('optimized by SangMzG'); // credTextShit.text += '\nFunkin';
